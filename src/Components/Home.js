    ...
    <div >
      ...
      <div className='AboutPage'>
        <div className='AboutText'>
          ...
          <p>
            My name is Alexus Brooklyn, and I currently reside in Atlanta, GA. I am a highly motivated and results-driven Software Engineer with a strong background in <b>full-stack development</b>, API integration, and analytics dashboard creation. <br /> <br />
            ...
            Outside of work, I often play basketball with my friends and do a lot of running. I mostly spend my free time watching the NFL and NBA, and am a huge fan of the Seahawks and LeBron James. Thanks for visiting my page, and please feel free to reach out or connect with me anytime!
          </p>
        </div>
        <Tilt>
