    ...
    return (
        <div className='AboutPage'>
            ...
            <p>
                ...
                <br></br>Setting everything else aside, I truly believe there is no greater gift than the salvation Jesus Christ has offered, and I'm so grateful to be saved by His grace. I'm always open to chatting, connecting, or meeting new people, so please feel free to reach out anytime!
            </p>
            </div>
            <Tilt>
